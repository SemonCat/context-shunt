...
READER_SYSTEM_PROMPT = (
    ...
    "hand is never trusted. `citation_ids` lists every entry in your `citations` array that "
    "supports that claim; a claim with no citation_ids is dropped, so never state a fact "
    "without one.\n"
